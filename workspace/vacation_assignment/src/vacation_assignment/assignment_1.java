...
public class assignment {
	...
	public static void assignment_9() {
		int a, b, c, i, sum = 0;
		Scanner scan = new Scanner(System.in);
		
		System.out.println("원하는 수의 범위 안에 속하는 자연수 중 홀수를 모두 합하는 프로그램입니다.");
		System.out.println("※주의※ 시작 수는 끝 수보다 무조건 작아야 합니다. (시작 수 < 끝 수)");
		System.out.println("시작 수 입력 : ");
		a = scan.nextInt();
		c = a;
		...
		System.out.println(a + "부터 " + b + "까지 홀수의 합은" + sum + "입니다.");
		System.out.println("끝!!!");
	}
	
	public static void assignment_10() {
		int a, b, c, i, sum = 0;
		Scanner scan = new Scanner(System.in);
		
		System.out.println("원하는 수의 범위 안에 속하는 자연수 중 짝수를 모두 합하는 프로그램입니다.");
		System.out.println("※주의※ 시작 수는 끝 수보다 무조건 작아야 합니다. (시작 수 < 끝 수)");
		System.out.println("시작 수 입력 : ");
		a = scan.nextInt();
		c = a;
		...
		System.out.println(a + "부터 " + b + "까지 짝수의 합은" + sum + "입니다.");
		System.out.println("끝!!!");
	}
